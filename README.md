...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/wexpect-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/wexpect-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `wexpect` available on your platform:
...
```
pixi search wexpect --channel conda-forge
```
